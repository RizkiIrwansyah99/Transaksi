        ...
        <form action='{{route('simpan.sales')}}' method='post' class="container">
            ...
            <div class="my-3 p-3 bg-body rounded shadow-sm">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name='subtotal' value="{{ old('subtotal')}}" id="subtotal">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name='diskon' value="{{ old('diskon')}}" id="diskon">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name='ongkir' value="{{ old('ongkir')}}" id="ongkir">
